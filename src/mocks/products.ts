...
const RAW_PRODUCTS: RawProduct[] = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1586816879360-004f5b0c51e5?q=80&w=600&auto=format&fit=crop",
    rating: 4.8,
    featured: false
  },
  {
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1505409859467-3a796fd5798e?q=80&w=600&auto=format&fit=crop",
    rating: 4.9,
    featured: false
  },
  {
...
export function getProductFallbackImage(id: string | number, category: string): string {
  ...
  const images: Record<string, string[]> = {
    "Eletrônicos / Mobile": [
      ...
      "https://images.unsplash.com/photo-1622445262464-84b14e47de1e?q=80&w=600&auto=format&fit=crop", 
      "https://images.unsplash.com/photo-1587829741301-dc798b83add3?q=80&w=600&auto=format&fit=crop"  
    ],
    "Móveis / Office": [
      "https://images.unsplash.com/photo-1513694203232-719a280e022f?q=80&w=600&auto=format&fit=crop", 
      "https://images.unsplash.com/photo-1551298370-9d3d53740c72?q=80&w=600&auto=format&fit=crop", 
...
export const MOCK_PRODUCTS: Product[] = RAW_PRODUCTS.map(p => {
  ...
  const validImg = getProductFallbackImage(codeId, p.category) || getProductFallbackImage(p.id, p.category);
  return {
    ...p,
    id: codeId,
    productID: codeId,
